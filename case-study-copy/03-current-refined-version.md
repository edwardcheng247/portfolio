...
Current `src/projects.ts` at HEAD, after the rewrite/refinement and later copy/image changes.

Source: extracted from `src/projects.ts` snapshot.
...
_Image caption: My audit of the existing components: nothing neutral, everything competing for attention._
...
_Image caption: Bounding the problem: the homepage had to hold up at both extremes._
...
_Image caption: The building block: one component that stacks, rows, and appends — shown here under the Benny Card balance._
...
_Image caption: Simplifying each section on the homepage using our new component._
...
_Image caption: Onboarding evolution: bonus → steps carousel → checklist._
...
_Image caption: The shipped homepage, optimized for both min and max states._
...
_Image caption: The new onboarding component drove a 70% increase in earners per signup._
...
_Image caption: The refined logos, ready to be embossed and foiled._
...
_Image caption: Card design: four colorways, front and back._

_Image caption: The card mailer: activate in three steps from the Benny App._
...
_Image caption: The KYC happy path — identity verification via Plaid._

_Image caption: The longer path with IDV, spec'd end to end._
...
_Image caption: The card tab: personalized color, quick actions, and recent activity._

_Image caption: Apple Wallet support, so the card works before the plastic arrives._
...
_Image caption: Speed varies for money movement, to offset same-day ACH costs._
...
_Image caption: Prompt users to add money and activate Benny Card._

### Measuring success: 30K on the waitlist

_Image caption: 30K users joined the waitlist. All UX flows approved by partners. Successful friends & family launch in late 2025._
...
_Image caption: Our Benny Card celebration merch._
...
_Image caption: The completion moment after the last card._
...
_Image caption: The shopping-list view: added deals and what they're worth._
...
_Image caption: The "Add receipt" button relocated into the Deals tab._
...
_Image caption: The three mechanics, consolidated under the Boosts framework._

### Shipped: Sweepstakes and gated offers

_Image caption: Sweepstakes: every deal redeemed is an entry._

_Image caption: Gating: SNAP offers unlock by engaging with deals._
...
_Image caption: The post-login flow wasn't ideal for either user profile._
...
_Image caption: A first mock designed to minimize engineering lift._
...
_Image caption: Designing the component set for the homepage — the seed of the new design language._
...
_Image caption: I pulled together references for leadership to critique._
...
_Image caption: I ended the workshop by having folks align on "jobs to be done."_
...
_Image caption: The second pass with our new design language._
...
_Image caption: The final spec: one unified view of projects, dashboards, and templates with real use-case descriptions._
...
_Image caption: The table view gives users even more control over their projects._

And from the nav menu, users can search across all the assets in their org, or switch orgs altogether.

_Image caption: Users can search on both dashboards and projects._

_Image caption: Users can switch orgs if they are part of multiple._
...
_Image caption: Looking ahead: users receive notifications of teammate activity._
